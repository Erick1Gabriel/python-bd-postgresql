...
def consultar(conexao):
    ...
    cursor.execute("select p.id,descricao,p.preco,p.estoque,categoria.nome descricao from produto p " +
...
def alterar(conexao):
    ...
    sql_update = "update produto set descricao=  %s, preco =  %s, estoque = %s, categoria_id where id =%s"
